...
class ShelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shelf" do
    assert_difference('Shelf.count') do
      post shelves_url, params: { shelf: { shelf_name: @shelf.shelf_name, shelf_note: @shelf.shelf_note } }
    end
  ...
  test "should update shelf" do
    patch shelf_url(@shelf), params: { shelf: { shelf_name: @shelf.shelf_name, shelf_note: @shelf.shelf_note } }
